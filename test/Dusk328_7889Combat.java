...
public class Dusk328_7889Combat extends NCombatScript {
    ...
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.ADAMANTITE_BAR_NOTED, 25, 58)));
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.MUSHROOM_POTATO_NOTED, 4, 6)));
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_ALWAYS);
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.GRANITE_CANNONBALL, 50, 100)));
        drop.table(dropTable.build());
        ...
        combat.killCount(NpcCombatKillCount.builder().asName("Grotesque Guardians").sendMessage(true).build());
