...
public class CursedDarkBeast374_16009Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.CURSED_DARK_BEAST_374_16009);
        ...
        combat.slayer(NpcCombatSlayer.builder().level(90).build());
        combat.focus(NpcCombatFocus.builder().meleeUnlessUnreachable(true).build());
        combat.combatScript("curseddarkbeast").deathAnimation(2733).blockAnimation(2732);
