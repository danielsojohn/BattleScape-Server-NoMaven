...
public class Zulrah725_2044Combat extends NCombatScript {
    ...
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.CROSSBOW_STRING_NOTED, 1000)));
        ...
        combat.stats(NpcCombatStats.builder().magicLevel(300).rangedLevel(300).defenceLevel(300).bonus(CombatBonus.ATTACK_MAGIC, 50).bonus(CombatBonus.ATTACK_RANGED, 50).bonus(CombatBonus.DEFENCE_MAGIC, 300).build());
