...
public class VetionReborn454Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.combatScript("VetionCS").type(NpcCombatType.UNDEAD).deathAnimation(5509).blockAnimation(5508);
