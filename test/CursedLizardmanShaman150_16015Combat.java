...
public class CursedLizardmanShaman150_16015Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.GRIMY_DWARF_WEED_NOTED, 1, 3)));
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.GRIMY_LANTADYME_NOTED, 1, 3)));
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.GRIMY_CADANTINE_NOTED, 1, 3)));
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(120).magicLevel(130).rangedLevel(120).defenceLevel(140).bonus(CombatBonus.MELEE_ATTACK, 45).bonus(CombatBonus.ATTACK_RANGED, 45).bonus(CombatBonus.DEFENCE_SLASH, 40).bonus(CombatBonus.DEFENCE_CRUSH, 30).bonus(CombatBonus.DEFENCE_MAGIC, 50).build());
