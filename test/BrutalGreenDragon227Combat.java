...
public class BrutalGreenDragon227Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        dropTable = NpcCombatDropTable.builder().chance(3.6);
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(268).magicLevel(168).defenceLevel(168).bonus(CombatBonus.DEFENCE_STAB, 50).bonus(CombatBonus.DEFENCE_SLASH, 70).bonus(CombatBonus.DEFENCE_CRUSH, 70).bonus(CombatBonus.DEFENCE_MAGIC, 60).bonus(CombatBonus.DEFENCE_RANGED, 50).build());
