...
public class DharokTheWretched115Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.DHAROK_THE_WRETCHED_115);
        combat.spawn(NpcCombatSpawn.builder().respawnDelay(75).build());
        combat.hitpoints(NpcCombatHitpoints.total(100));
        combat.stats(NpcCombatStats.builder().attackLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_SLASH, 103).bonus(CombatBonus.ATTACK_CRUSH, 95).bonus(CombatBonus.DEFENCE_STAB, 252).bonus(CombatBonus.DEFENCE_SLASH, 250).bonus(CombatBonus.DEFENCE_CRUSH, 244).bonus(CombatBonus.DEFENCE_MAGIC, -11).bonus(CombatBonus.DEFENCE_RANGED, 249).build());
        combat.killCount(NpcCombatKillCount.builder().asName("Barrows brother").build());
        combat.combatScript("DharokCS").deathAnimation(836).blockAnimation(424);
