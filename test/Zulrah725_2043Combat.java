...
public class Zulrah725_2043Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.stats(NpcCombatStats.builder().magicLevel(300).rangedLevel(300).defenceLevel(300).bonus(CombatBonus.ATTACK_MAGIC, 50).bonus(CombatBonus.ATTACK_RANGED, 50).bonus(CombatBonus.DEFENCE_RANGED, 300).build());
