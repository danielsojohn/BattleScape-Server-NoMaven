...
public class BattleMage54_1612Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.BATTLE_MAGE_54_1612);
        ...
        combat.combatScript("battlemage").deathAnimation(196).blockAnimation(193);
