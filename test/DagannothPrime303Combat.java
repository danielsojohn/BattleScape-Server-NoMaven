...
public class DagannothPrime303Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.EARTH_TALISMAN_NOTED, 1, 80)));
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.WATER_TALISMAN_NOTED, 1, 80)));
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(255).magicLevel(255).defenceLevel(255).bonus(CombatBonus.MELEE_DEFENCE, 255).bonus(CombatBonus.DEFENCE_MAGIC, 255).bonus(CombatBonus.DEFENCE_RANGED, 10).build());
