...
public class JalAkrekMej70Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        var combat = NpcCombatDefinition.builder();
        combat.id(NpcId.JAL_AKREK_MEJ_70);
        combat.hitpoints(NpcCombatHitpoints.total(15));
        combat.stats(NpcCombatStats.builder().magicLevel(120).defenceLevel(95).bonus(CombatBonus.ATTACK_MAGIC, 25).bonus(CombatBonus.DEFENCE_MAGIC, 25).build());
