...
public class Aviansie92Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.AVIANSIE_92);
        combat.hitpoints(NpcCombatHitpoints.total(95));
        combat.stats(NpcCombatStats.builder().rangedLevel(90).defenceLevel(100).build());
