...
public class Cyclops81Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.CYCLOPS_81);
        combat.hitpoints(NpcCombatHitpoints.total(110));
        combat.stats(NpcCombatStats.builder().attackLevel(80).defenceLevel(50).build());
        combat.aggression(NpcCombatAggression.PLAYERS);
        combat.combatScript("BandosGWDCS").deathAnimation(4653).blockAnimation(4651);
