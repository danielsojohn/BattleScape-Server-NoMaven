...
public class AbhorrentSpectre253Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.ABHORRENT_SPECTRE_253);
        combat.hitpoints(NpcCombatHitpoints.builder().total(250).bar(HitpointsBar.GREEN_RED_60).build());
        combat.stats(NpcCombatStats.builder().magicLevel(300).defenceLevel(180).bonus(CombatBonus.MELEE_DEFENCE, 40).bonus(CombatBonus.DEFENCE_RANGED, 30).build());
        combat.slayer(NpcCombatSlayer.builder().level(60).experience(2500).build());
