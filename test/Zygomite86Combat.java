...
public class Zygomite86Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(75).magicLevel(75).rangedLevel(75).defenceLevel(75).bonus(CombatBonus.MELEE_ATTACK, 30).bonus(CombatBonus.MELEE_DEFENCE, 10).bonus(CombatBonus.DEFENCE_MAGIC, 20).bonus(CombatBonus.DEFENCE_RANGED, 20).build());
