...
public class AbyssalWalker81Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(5).defenceLevel(95).bonus(CombatBonus.MELEE_ATTACK, 5).bonus(CombatBonus.DEFENCE_STAB, 75).bonus(CombatBonus.DEFENCE_SLASH, 75).bonus(CombatBonus.DEFENCE_CRUSH, 10).bonus(CombatBonus.DEFENCE_MAGIC, 75).bonus(CombatBonus.DEFENCE_RANGED, 75).build());
