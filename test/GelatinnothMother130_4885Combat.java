...
public class GelatinnothMother130_4885Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        var combat = NpcCombatDefinition.builder();
        combat.id(NpcId.GELATINNOTH_MOTHER_130_4885);
        ...
        combat.combatScript("GelatinnothMotherCS").deathAnimation(1342).blockAnimation(1343);
