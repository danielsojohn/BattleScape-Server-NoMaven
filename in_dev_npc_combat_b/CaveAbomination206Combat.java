...
public class CaveAbomination206Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.BLACK_MASK)));
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.MAHOGANY_LOGS, 2, 4)));
        drop.table(dropTable.build());
        ...
        combat.id(NpcId.CAVE_ABOMINATION_206);
        ...
        combat.slayer(NpcCombatSlayer.builder().level(58).experience(1300).build());
