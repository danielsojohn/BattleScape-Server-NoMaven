...
public class BrutalBlueDragon271Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(0.4).order(NpcCombatDropTable.Order.RANDOM_UNIQUE);
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(298).magicLevel(198).defenceLevel(198).bonus(CombatBonus.DEFENCE_STAB, 50).bonus(CombatBonus.DEFENCE_SLASH, 70).bonus(CombatBonus.DEFENCE_CRUSH, 70).bonus(CombatBonus.DEFENCE_MAGIC, 60).bonus(CombatBonus.DEFENCE_RANGED, 50).build());
