...
public class CursedAbyssalDemon342_16010Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        var drop = NpcCombatDrop.builder().rareDropTableRate(NpcCombatDropTable.CHANCE_1_IN_256);
        var dropTable = NpcCombatDropTable.builder().chance(0.032).log(true);
        ...
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(0.24).log(true);
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.BLUDGEON_SPINE)));
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.BLUDGEON_CLAW)));
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.BLUDGEON_AXON)));
        drop.table(dropTable.build());
        ...
        combat.id(NpcId.CURSED_ABYSSAL_DEMON_342_16010);
        ...
        combat.combatScript("cursedabyssaldemon").type(NpcCombatType.DEMON).deathAnimation(1538).blockAnimation(2309);
