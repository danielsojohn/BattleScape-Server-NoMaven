...
public class CaveKraken127Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(0.75).log(true);
        ...
        combat.id(NpcId.CAVE_KRAKEN_127);
        combat.noclip(true);
        ...
        combat.combatScript("CaveKrakenCS").deathAnimation(3993).blockAnimation(3990);
