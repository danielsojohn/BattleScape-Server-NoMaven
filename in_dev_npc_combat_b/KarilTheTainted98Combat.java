...
public class KarilTheTainted98Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.KARIL_THE_TAINTED_98);
        combat.spawn(NpcCombatSpawn.builder().respawnDelay(75).build());
        combat.hitpoints(NpcCombatHitpoints.total(100));
        combat.stats(NpcCombatStats.builder().rangedLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_RANGED, 134).bonus(CombatBonus.DEFENCE_STAB, 79).bonus(CombatBonus.DEFENCE_SLASH, 71).bonus(CombatBonus.DEFENCE_CRUSH, 90).bonus(CombatBonus.DEFENCE_MAGIC, 106).bonus(CombatBonus.DEFENCE_RANGED, 100).build());
        ...
        combat.combatScript("KarilCS").deathAnimation(836).blockAnimation(424);
