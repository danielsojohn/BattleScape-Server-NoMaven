...
public class Aviansie69Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.AVIANSIE_69);
        combat.hitpoints(NpcCombatHitpoints.total(70));
        combat.stats(NpcCombatStats.builder().rangedLevel(71).defenceLevel(70).build());
