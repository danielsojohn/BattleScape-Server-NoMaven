...
public class Aviansie137Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.id(NpcId.AVIANSIE_137);
        combat.hitpoints(NpcCombatHitpoints.total(124));
        combat.stats(NpcCombatStats.builder().rangedLevel(136).defenceLevel(160).build());
