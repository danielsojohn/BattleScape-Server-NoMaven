...
public class FireElemental35Combat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(35).magicLevel(20).rangedLevel(20).defenceLevel(20).build());
