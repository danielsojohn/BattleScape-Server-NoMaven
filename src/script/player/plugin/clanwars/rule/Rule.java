package script.player.plugin.clanwars.rule;
...
@Getter
public enum Rule {
    GAME_END(VarbitId.CLAN_WARS_GAME_END, RuleOption.LAST_TEAM_STANDING, RuleOption.KILLS_25, RuleOption.KILLS_50,
            RuleOption.KILLS_100, RuleOption.KILLS_200, RuleOption.KILLS_500, RuleOption.KILLS_1000,
            RuleOption.KILLS_5000, RuleOption.KILLS_10000, RuleOption.KING_80_POINTS, RuleOption.KING_250_POINTS,
            RuleOption.KING_750_POINTS, RuleOption.KING_1500_POINTS, RuleOption.KING_2500_POINTS,
            RuleOption.KING_4000_POINTS, RuleOption.KING_6000_POINTS, RuleOption.MOST_KILLS_5_MINS,
            RuleOption.MOST_KILLS_10_MINS, RuleOption.MOST_KILLS_20_MINS, RuleOption.MOST_KILLS_60_MINS,
            RuleOption.MOST_KILLS_120_MINS, RuleOption.ODDSKULL_100_POINTS, RuleOption.ODDSKULL_300_POINTS,
            RuleOption.ODDSKULL_500_POINTS),
    MELEE(VarbitId.CLAN_WARS_MELEE, RuleOption.ALLOWED, RuleOption.DISABLED),
    RANGING(VarbitId.CLAN_WARS_RANGING, RuleOption.ALLOWED, RuleOption.DISABLED),
    MAGIC(VarbitId.CLAN_WARS_MAGIC, RuleOption.ALLOWED, RuleOption.STANDARD_SPELLS, RuleOption.BINDING_ONLY,
            RuleOption.DISABLED),
    PRAYER(VarbitId.CLAN_WARS_PRAYER, RuleOption.ALLOWED, RuleOption.NO_OVERHEADS, RuleOption.DISABLED),
    FOOD(VarbitId.CLAN_WARS_FOOD, RuleOption.ALLOWED, RuleOption.DISABLED),
    DRINKS(VarbitId.CLAN_WARS_DRINKS, RuleOption.ALLOWED, RuleOption.DISABLED),
    SPECIAL_ATTACKS(VarbitId.CLAN_WARS_SPECIAL_ATTACKS, RuleOption.ALLOWED, RuleOption.NO_STAFF_OF_THE_DEAD,
            RuleOption.DISABLED),
    STRAGGLERS(VarbitId.CLAN_WARS_STRAGGLERS, RuleOption.KILL_EM_ALL, RuleOption.IGNORE_5),
    IGNORE_FREEZING(VarbitId.CLAN_WARS_IGNORE_FREEZING, RuleOption.DISABLED, RuleOption.ALLOWED),
    PJ_TIMER(VarbitId.CLAN_WARS_PJ_TIMER, RuleOption.DISABLED, RuleOption.ALLOWED),
    ALLOW_TRIDENT_IN_PVP(VarbitId.CLAN_WARS_ALLOW_TRIDENT_IN_PVP, RuleOption.DISABLED, RuleOption.ALLOWED),
    SINGLE_SPELLS(VarbitId.CLAN_WARS_SINGLE_SPELLS, RuleOption.DISABLED, RuleOption.ALLOWED),
    ARENA(VarbitId.CLAN_WARS_ARENA, RuleOption.WASTELAND, RuleOption.PLATEAU, RuleOption.SYLVAN_GLADE,
            RuleOption.FORSAKEN_QUARRY, RuleOption.TURRETS, RuleOption.CLAN_CUP, RuleOption.SOGGY_SWAMP,
            RuleOption.GHASTLY_SWAMP, RuleOption.NORTHLEACH_QUELL, RuleOption.GRIDLOCK, RuleOption.ETHREAL,
            RuleOption.CLASSIC, RuleOption.LUMBRIDGE, RuleOption.FALADOR);
    ...
    private Rule(int varbit, RuleOption... options) {
        this.varbit = varbit;
        this.options = Utils.toList(options);
    }
    ...
    public static String getDescriptions(int[] rules) {
        ...
        builder.append("<u=FFFFFF><col=FFFFFF>The Arena:</col></u> " + Arena.get(rules[Rule.ARENA.ordinal()]).getName()
                + "<br><br>");
        ...
        builder.append(DESCRIPTIONS.get(SPECIAL_ATTACKS.ordinal() << 16 | rules[SPECIAL_ATTACKS.ordinal()]));
        builder.append("<u=FFFFFF><col=FFFFFF>Other settings:</col></u><br><br>");
        builder.append(DESCRIPTIONS.get(IGNORE_FREEZING.ordinal() << 16 | rules[IGNORE_FREEZING.ordinal()]));
        builder.append(DESCRIPTIONS.get(PJ_TIMER.ordinal() << 16 | rules[PJ_TIMER.ordinal()]));
        builder.append(DESCRIPTIONS.get(SINGLE_SPELLS.ordinal() << 16 | rules[SINGLE_SPELLS.ordinal()]));
        builder.append(DESCRIPTIONS.get(ALLOW_TRIDENT_IN_PVP.ordinal() << 16 | rules[ALLOW_TRIDENT_IN_PVP.ordinal()]));
