    ...
    public boolean widgetOnWidgetHook(int useWidgetId, int useChildId, int onWidgetId, int onChildId, int useSlot,
        ...
        if (useWidgetId == WidgetId.SPELLBOOK && onWidgetId == WidgetId.INVENTORY) {
            ...
            case SUPERHEAT_ITEM:
                ...
                } else if (onItemId == ItemId.IRON_ORE && player.getInventory().getCount(ItemId.COAL) >= 2) {
            ...
            case LVL_3_ENCHANT:
                ...
                if (onItemId != ItemId.RUBY_RING && onItemId != ItemId.RUBY_NECKLACE && onItemId != ItemId.RUBY_AMULET
                        && onItemId != ItemId.RUBY_BRACELET) {
                    player.getGameEncoder().sendMessage("You can't use this spell on this item.");
                    return true;
                }
            ...
            case LVL_6_ENCHANT:
                ...
                if (onItemId != ItemId.ONYX_RING && onItemId != ItemId.ONYX_NECKLACE && onItemId != ItemId.ONYX_AMULET
                        && onItemId != ItemId.ONYX_BRACELET) {
                    player.getGameEncoder().sendMessage("You can't use this spell on this item.");
                    return true;
                }
                player.setAnimation(721);
            ...
            case LVL_7_ENCHANT:
                ...
                if (!player.getMagic().hasRunes(ItemId.BLOOD_RUNE, 20) || !player.getMagic().hasRunes(566, 20)
                        || !player.getMagic().hasRunes(ItemId.COSMIC_RUNE, 1)) {
                    player.getMagic().notEnoughRunes();
                    return true;
                }
