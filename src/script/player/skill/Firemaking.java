...
public class Firemaking extends SkillContainer {
    ...
    static {
        entries.add(SkillEntry.builder().level(1).experience(40).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 461808)).build());
        entries.add(SkillEntry.builder().level(1).experience(40).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.ACHEY_TREE_LOGS)).build());
        entries.add(SkillEntry.builder().level(1).experience(40).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.KINDLING_20799))
                .pet(new SkillPet(ItemId.PHOENIX, 461808)).build());
        entries.add(SkillEntry.builder().level(15).experience(60).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.OAK_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 443697)).build());
        entries.add(SkillEntry.builder().level(30).experience(90).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.WILLOW_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 435165)).build());
        entries.add(SkillEntry.builder().level(35).experience(105).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.TEAK_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 426954)).build());
        entries.add(SkillEntry.builder().level(42).experience(125).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.ARCTIC_PINE_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 382609)).build());
        entries.add(SkillEntry.builder().level(45).experience(135).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.MAPLE_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 305792)).build());
        entries.add(SkillEntry.builder().level(50).experience(157).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.MAHOGANY_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 170874)).build());
        entries.add(SkillEntry.builder().level(60).experience(202).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.YEW_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 149434)).build());
        entries.add(SkillEntry.builder().level(75).experience(303).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.MAGIC_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 138583)).build());
        entries.add(SkillEntry.builder().level(90).experience(350).animation(START_FIRE_ANIMATION).alwaysMake1(true)
                .tool(new Item(ItemId.TINDERBOX)).consume(new RandomItem(ItemId.REDWOOD_LOGS))
                .pet(new SkillPet(ItemId.PHOENIX, 128885)).build());
        entries.add(SkillEntry.builder().level(49).tool(new Item(ItemId.TINDERBOX))
                .consume(new RandomItem(ItemId.BULLSEYE_LANTERN)).create(new RandomItem(ItemId.BULLSEYE_LANTERN_4550))
                .build());
    }
}
