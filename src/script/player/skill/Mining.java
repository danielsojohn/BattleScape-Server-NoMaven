...
public class Mining extends SkillContainer {
    private static final MiningPickaxe[] PICKAXES = {
        new MiningPickaxe(ItemId.BRONZE_PICKAXE, 1, 625, 6753), new MiningPickaxe(ItemId.IRON_PICKAXE, 1, 626, 6754),
        new MiningPickaxe(ItemId.STEEL_PICKAXE, 6, 627, 6755), new MiningPickaxe(ItemId.BLACK_PICKAXE, 11, 625, 6753),
        new MiningPickaxe(ItemId.MITHRIL_PICKAXE, 21, 629, 6757),
        new MiningPickaxe(ItemId.ADAMANT_PICKAXE, 31, 628, 6756), new MiningPickaxe(ItemId.RUNE_PICKAXE, 41, 624, 6752),
    ...
    public boolean inMembersMiningGuild(Player player) {
        return player.getX() >= 3009 && player.getY() >= 9698 && player.getX() <= 3058 && player.getY() <= 9729;
    }
    ...
    static {
        ...
        entries.add(SkillEntry.builder().level(30).experience(50).mapObject(new SkillModel(7456, 0))
                ...
                .temporaryMapObject(new SkillTemporaryMapObject(7468, 7, 4)).variable(UNIDENTIFIED_MINERAL_VARIABLE, 60)
                .build());
