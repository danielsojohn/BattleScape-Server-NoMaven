...
import com.palidino.osrs.model.map.ObjectDef;
...
public class Cooking extends SkillContainer {
    ...
    public Item createHook(Player player, Item item, Npc npc, MapObject mapObject, SkillEntry entry) {
        if (mapObject != null && isFire(mapObject.getName())) {
            if (item.getName().endsWith("s")) {
                player.getGameEncoder().sendFilteredMessage("You successfully cook some " + item.getName() + ".");
            } else if (item.getAmount() > 1) {
                player.getGameEncoder().sendFilteredMessage("You successfully cook some " + item.getName() + "s.");
            } else {
                player.getGameEncoder().sendFilteredMessage("You successfully cook a " + item.getName() + ".");
            }
        }
        return item;
    }
    ...
    @Override
    public Item failedCreateHook(Player player, Item item, Npc npc, MapObject mapObject, SkillEntry entry) {
        if (mapObject != null && isFire(mapObject.getName())) {
    ...
    public boolean failedActionHook(Player player, Event event, Npc npc, MapObject mapObject, SkillEntry entry) {
        ...
        if (player.getEquipment().getHandId() == ItemId.COOKING_GAUNTLETS && entry.getCreate() != null) {
        ...
        if (failFactor > 0 && level >= failFactor || player.getEquipment().wearingAccomplishmentCape(getSkillId())) {
            return false;
        }
        var power = level + 8;
    ...
    @Override
    public boolean findEntriesMapObjectMatchHook(Player player, SkillModel mapObjectModel, int widgetOnMapObjectId,
            SkillEntry entry) {
        var fireName = "";
    ...
    private boolean isFire(String name) {
        return name.equals("fire") || name.endsWith("range") || name.endsWith("stove") || name.endsWith("oven");
    }
    ...
    static {
        entries.add(SkillEntry.builder().level(1).failFactor(33).experience(30).animation(883)
                ...
                .create(new RandomItem(ItemId.SHRIMPS)).failedCreate(new RandomItem(ItemId.BURNT_FISH)).build());
        entries.add(SkillEntry.builder().level(1).failFactor(33).experience(30).animation(883)
                .widgetOnMapObject(COOKING_RANGE_ID).consume(new RandomItem(ItemId.RAW_ANCHOVIES))
                .create(new RandomItem(ItemId.ANCHOVIES)).failedCreate(new RandomItem(ItemId.BURNT_FISH)).build());
        entries.add(SkillEntry.builder().level(1).failFactor(40).experience(35).animation(883)
                ...
                .create(new RandomItem(ItemId.SARDINE)).failedCreate(new RandomItem(ItemId.BURNT_FISH_369)).build());
        entries.add(SkillEntry.builder().level(15).failFactor(50).experience(70).animation(883)
                ...
                .create(new RandomItem(ItemId.TROUT)).failedCreate(new RandomItem(ItemId.BURNT_FISH_343)).build());
        entries.add(SkillEntry.builder().level(20).failFactor(59).experience(80).animation(883)
                ...
                .create(new RandomItem(ItemId.PIKE)).failedCreate(new RandomItem(ItemId.BURNT_FISH_343)).build());
        entries.add(SkillEntry.builder().level(25).failFactor(58).experience(70).animation(883)
                ...
                .create(new RandomItem(ItemId.SALMON)).failedCreate(new RandomItem(ItemId.BURNT_FISH_343)).build());
        entries.add(SkillEntry.builder().level(30).failFactor(99).experience(190).animation(883)
                ...
                .create(new RandomItem(ItemId.COOKED_KARAMBWAN)).failedCreate(new RandomItem(ItemId.BURNT_KARAMBWAN))
                .build());
        entries.add(SkillEntry.builder().level(30).failFactor(64).experience(80).animation(883)
                ...
                .create(new RandomItem(ItemId.TUNA)).failedCreate(new RandomItem(ItemId.BURNT_FISH_367)).build());
        ...
        entries.add(SkillEntry.builder().level(62).failFactor(90).experience(150).animation(883)
                ...
                .create(new RandomItem(ItemId.MONKFISH)).failedCreate(new RandomItem(ItemId.BURNT_MONKFISH)).build());
        entries.add(SkillEntry.builder().level(80).failFactor(104).experience(210).animation(883)
                ...
                .create(new RandomItem(ItemId.SHARK)).failedCreate(new RandomItem(ItemId.BURNT_SHARK)).build());
        entries.add(SkillEntry.builder().level(84).failFactor(108).experience(230).animation(883)
                ...
                .create(new RandomItem(ItemId.ANGLERFISH)).failedCreate(new RandomItem(ItemId.BURNT_ANGLERFISH))
                .build());
        ...
        entries.add(SkillEntry.builder().level(15).experience(15).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_SUPHI_FISH_1)).create(new RandomItem(ItemId.SUPHI_FISH_1))
                .failedCreate(new RandomItem(ItemId.BURNT_FISH_20854)).build());
        entries.add(SkillEntry.builder().level(30).experience(20).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_LECKISH_FISH_2)).create(new RandomItem(ItemId.LECKISH_FISH_2))
                .failedCreate(new RandomItem(ItemId.BURNT_FISH_20854)).build());
        entries.add(SkillEntry.builder().level(45).experience(25).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_BRAWK_FISH_3)).create(new RandomItem(ItemId.BRAWK_FISH_3))
                .failedCreate(new RandomItem(ItemId.BURNT_FISH_20854)).build());
        entries.add(SkillEntry.builder().level(60).experience(30).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_MYCIL_FISH_4)).create(new RandomItem(ItemId.MYCIL_FISH_4))
                .failedCreate(new RandomItem(ItemId.BURNT_FISH_20854)).build());
        entries.add(SkillEntry.builder().level(75).experience(35).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_ROQED_FISH_5)).create(new RandomItem(ItemId.ROQED_FISH_5))
                .failedCreate(new RandomItem(ItemId.BURNT_FISH_20854)).build());
        entries.add(SkillEntry.builder().level(90).experience(38).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_KYREN_FISH_6)).create(new RandomItem(ItemId.KYREN_FISH_6))
                .failedCreate(new RandomItem(ItemId.BURNT_FISH_20854)).build());
        entries.add(SkillEntry.builder().level(1).experience(10).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_GUANIC_BAT_0)).create(new RandomItem(ItemId.GUANIC_BAT_0))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
        entries.add(SkillEntry.builder().level(15).experience(15).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_PRAEL_BAT_1)).create(new RandomItem(ItemId.PRAEL_BAT_1))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
        entries.add(SkillEntry.builder().level(30).experience(20).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_GIRAL_BAT_2)).create(new RandomItem(ItemId.GIRAL_BAT_2))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
        entries.add(SkillEntry.builder().level(45).experience(25).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_PHLUXIA_BAT_3)).create(new RandomItem(ItemId.PHLUXIA_BAT_3))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
        entries.add(SkillEntry.builder().level(60).experience(30).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_KRYKET_BAT_4)).create(new RandomItem(ItemId.KRYKET_BAT_4))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
        entries.add(SkillEntry.builder().level(75).experience(35).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_MURNG_BAT_5)).create(new RandomItem(ItemId.MURNG_BAT_5))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
        entries.add(SkillEntry.builder().level(90).experience(38).animation(883).widgetOnMapObject(COOKING_RANGE_ID)
                .consume(new RandomItem(ItemId.RAW_PSYKK_BAT_6)).create(new RandomItem(ItemId.PSYKK_BAT_6))
                .failedCreate(new RandomItem(ItemId.BURNT_BAT)).build());
    }
}
