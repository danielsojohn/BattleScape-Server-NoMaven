...
public class Woodcutting extends SkillContainer {
    private static final WoodcuttingHatchet[] HATCHETS = {
        new WoodcuttingHatchet(ItemId.BRONZE_AXE, 1, 879), new WoodcuttingHatchet(ItemId.IRON_AXE, 1, 877),
        new WoodcuttingHatchet(ItemId.STEEL_AXE, 6, 875), new WoodcuttingHatchet(ItemId.MITHRIL_AXE, 21, 871),
        new WoodcuttingHatchet(ItemId.ADAMANT_AXE, 31, 869), new WoodcuttingHatchet(ItemId.RUNE_AXE, 41, 867),
        new WoodcuttingHatchet(ItemId.GILDED_AXE, 41, 8303), new WoodcuttingHatchet(ItemId.DRAGON_AXE, 61, 2846),
        new WoodcuttingHatchet(ItemId._3RD_AGE_AXE, 61, 7264), new WoodcuttingHatchet(ItemId.INFERNAL_AXE, 61, 2117),
        new WoodcuttingHatchet(ItemId.INFERNAL_AXE_UNCHARGED, 61, 2117)
    };
    private static final Item[] COLORED_EGG_NESTS = {
        new Item(ItemId.BIRD_NEST), new Item(ItemId.BIRD_NEST_5071), new Item(ItemId.BIRD_NEST_5072)
    };
    private static final Item[] EVIL_CHICKEN_OUTFIT = {
        new Item(ItemId.EVIL_CHICKEN_FEET), new Item(ItemId.EVIL_CHICKEN_WINGS), new Item(ItemId.EVIL_CHICKEN_HEAD),
    ...
    static {
        entries.add(SkillEntry.builder().level(1).experience(25).mapObject(new SkillModel(1276, 0))
                ...
                .create(new RandomItem(ItemId.LOGS)).pet(new SkillPet(ItemId.BEAVER, 317647)).clueChance(317647)
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 1, 8)).build());
        entries.add(SkillEntry.builder().level(15).experience(38).mapObject(new SkillModel(1751, 0))
                .create(new RandomItem(ItemId.OAK_LOGS)).pet(new SkillPet(ItemId.BEAVER, 361146)).clueChance(361146)
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 3, 8)).build());
        ...
        entries.add(SkillEntry.builder().level(45).experience(100).mapObject(new SkillModel(1759, 0))
                .create(new RandomItem(ItemId.MAPLE_LOGS)).pet(new SkillPet(ItemId.BEAVER, 221918)).clueChance(221918)
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 11, 8)).build());
        entries.add(SkillEntry.builder().level(60).experience(175).mapObject(new SkillModel(1753, 0))
                .create(new RandomItem(ItemId.YEW_LOGS)).pet(new SkillPet(ItemId.BEAVER, 145013)).clueChance(145013)
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 15, 8)).build());
        entries.add(SkillEntry.builder().level(75).experience(250).mapObject(new SkillModel(1761, 0))
                .create(new RandomItem(ItemId.MAGIC_LOGS)).pet(new SkillPet(ItemId.BEAVER, 72321)).clueChance(72321)
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 18, 8)).build());
