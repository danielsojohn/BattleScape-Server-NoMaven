...
public class Fishing extends SkillContainer {
    ...
    static {
        entries.add(SkillEntry.builder().level(1).experience(10).animation(621)
                .npc(new SkillModel(NpcId.FISHING_SPOT_1514, 0)).npc(new SkillModel(NpcId.FISHING_SPOT_1518, 0))
                .tool(new Item(ItemId.SMALL_FISHING_NET)).create(new RandomItem(ItemId.RAW_SHRIMPS))
                .pet(new SkillPet(ItemId.HERON, 435165)).clueChance(870330).build());
        ...
        entries.add(SkillEntry.builder().level(15).experience(40).animation(621)
                ...
                .create(new RandomItem(ItemId.RAW_ANCHOVIES)).pet(new SkillPet(ItemId.HERON, 435165)).clueChance(870330)
                .build());
        ...
        entries.add(SkillEntry.builder().level(70).extraLevel(Skills.STRENGTH, 45).extraLevel(Skills.AGILITY, 45)
                .experience(80).animation(622).npc(new SkillModel(NpcId.FISHING_SPOT_1542, 0))
                .tool(new Item(ItemId.BARBARIAN_ROD)).consume(new RandomItem(ItemId.FEATHER))
                .create(new RandomItem(ItemId.LEAPING_STURGEON)).pet(new SkillPet(ItemId.HERON, 426954))
