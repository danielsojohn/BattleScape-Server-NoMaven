...
public class GeneralGraardor624Combat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        graardorCombat.stats(NpcCombatStats.builder().attackLevel(280).magicLevel(80).rangedLevel(350).defenceLevel(250)
        ...
        graardorCombat.focus(NpcCombatFocus.builder().keepWithinDistance(1).singleTargetFocus(true).build());
        ...
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.BANDOS_CHESTPLATE).weight(1)));
        ...
        grimspikeCombat.spawn(NpcCombatSpawn.builder().respawnDelay(50).respawnWithId(NpcId.GENERAL_GRAARDOR_624)
                .respawnWithId(NpcId.SERGEANT_STRONGSTACK_141).respawnWithId(NpcId.SERGEANT_STEELWILL_142).build());
        grimspikeCombat.hitpoints(NpcCombatHitpoints.total(146));
        grimspikeCombat.stats(NpcCombatStats.builder().attackLevel(80).magicLevel(50).rangedLevel(150).defenceLevel(132)
                .bonus(CombatBonus.ATTACK_RANGED, 20).build());
        grimspikeCombat.aggression(NpcCombatAggression.builder().range(16).build());
        grimspikeCombat.killCount(NpcCombatKillCount.builder().asName("General Graardor's bodyguard").build());
        ...
        var steelwillDrop = NpcCombatDrop.builder().rareDropTableRate(NpcCombatDropTable.CHANCE_1_IN_256);
