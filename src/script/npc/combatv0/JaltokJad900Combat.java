...
public class JaltokJad900Combat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(750).magicLevel(510).rangedLevel(1020).defenceLevel(480)
                .bonus(CombatBonus.ATTACK_STAB, 80).bonus(CombatBonus.ATTACK_SLASH, 80)
