...
public class Callisto470Combat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(350).defenceLevel(440).bonus(CombatBonus.DEFENCE_STAB, 135)
                .bonus(CombatBonus.DEFENCE_SLASH, 104).bonus(CombatBonus.DEFENCE_CRUSH, 175)
                .bonus(CombatBonus.DEFENCE_MAGIC, 900).bonus(CombatBonus.DEFENCE_RANGED, 230).build());
