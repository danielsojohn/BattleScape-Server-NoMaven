...
public class GargoyleCombat extends NpcCombat {
    private static final NpcCombatDropTable SUPERIOR_DROP_TABLE = NpcCombatDropTable.builder().chance(1.55).log(true)
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_150).slayerTask(true).log(true);
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(75).defenceLevel(107).bonus(CombatBonus.DEFENCE_STAB, 20)
                .bonus(CombatBonus.DEFENCE_SLASH, 20).bonus(CombatBonus.DEFENCE_MAGIC, 20)
        ...
        cursedCombat.hitpoints(NpcCombatHitpoints.builder().total(270).bar(HitpointsBar.GREEN_RED_60).build());
        ...
        superiorCombat.hitpoints(NpcCombatHitpoints.builder().total(270).bar(HitpointsBar.GREEN_RED_60).build());
