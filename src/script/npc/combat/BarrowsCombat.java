...
public class BarrowsCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        ahrim.stats(NpcCombatStats.builder().magicLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_STAB, 12)
                .bonus(CombatBonus.ATTACK_CRUSH, 65).bonus(CombatBonus.ATTACK_MAGIC, 73)
                .bonus(CombatBonus.DEFENCE_STAB, 103).bonus(CombatBonus.DEFENCE_SLASH, 85)
                .bonus(CombatBonus.DEFENCE_CRUSH, 117).bonus(CombatBonus.DEFENCE_MAGIC, 73).build());
        ...
        dharok.stats(NpcCombatStats.builder().attackLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_SLASH, 103)
                .bonus(CombatBonus.ATTACK_CRUSH, 95).bonus(CombatBonus.DEFENCE_STAB, 252)
                .bonus(CombatBonus.DEFENCE_SLASH, 250).bonus(CombatBonus.DEFENCE_CRUSH, 244)
                .bonus(CombatBonus.DEFENCE_MAGIC, -11).bonus(CombatBonus.DEFENCE_RANGED, 249).build());
        ...
        guthan.stats(NpcCombatStats.builder().attackLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_STAB, 75)
                .bonus(CombatBonus.ATTACK_SLASH, 75).bonus(CombatBonus.ATTACK_CRUSH, 75)
                .bonus(CombatBonus.DEFENCE_STAB, 259).bonus(CombatBonus.DEFENCE_SLASH, 257)
                .bonus(CombatBonus.DEFENCE_CRUSH, 241).bonus(CombatBonus.DEFENCE_MAGIC, -11)
        ...
        karil.stats(NpcCombatStats.builder().rangedLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_RANGED, 134)
                .bonus(CombatBonus.DEFENCE_STAB, 79).bonus(CombatBonus.DEFENCE_SLASH, 71)
                .bonus(CombatBonus.DEFENCE_CRUSH, 90).bonus(CombatBonus.DEFENCE_MAGIC, 106)
        ...
        torag.stats(NpcCombatStats.builder().attackLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_STAB, 68)
                .bonus(CombatBonus.ATTACK_CRUSH, 82).bonus(CombatBonus.DEFENCE_STAB, 221)
                .bonus(CombatBonus.DEFENCE_SLASH, 235).bonus(CombatBonus.DEFENCE_CRUSH, 222)
                .bonus(CombatBonus.DEFENCE_RANGED, 221).build());
        ...
        verac.stats(NpcCombatStats.builder().attackLevel(100).defenceLevel(100).bonus(CombatBonus.ATTACK_STAB, 68)
                .bonus(CombatBonus.ATTACK_CRUSH, 82).bonus(CombatBonus.DEFENCE_STAB, 227)
                .bonus(CombatBonus.DEFENCE_SLASH, 230).bonus(CombatBonus.DEFENCE_CRUSH, 221)
                .bonus(CombatBonus.DEFENCE_RANGED, 225).build());
        ...
        return Arrays.asList(ahrim.build(), dharok.build(), guthan.build(), karil.build(), torag.build(),
                verac.build());
    }
    ...
    public void applyAttackEndHook(NpcCombatStyle combatStyle, Entity opponent, int count, HitEvent hitEvent) {
        ...
        if (npc.getId() == NpcId.AHRIM_THE_BLIGHTED_98) {
            ...
            if (combatStyle != AHRIM_STUN && combatStyle != AHRIM_ENFEEBLE && combatStyle != AHRIM_VULNERABILITY
