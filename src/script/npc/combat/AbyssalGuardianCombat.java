...
public class AbyssalGuardianCombat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        var drop = NpcCombatDrop.builder().clue(NpcCombatDrop.ClueScroll.MEDIUM, NpcCombatDropTable.CHANCE_1_IN_128);
        var dropTable = NpcCombatDropTable.builder().chance(2.38).order(NpcCombatDropTable.Order.UNIQUE);
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(30).defenceLevel(30).bonus(CombatBonus.MELEE_ATTACK, 15)
                .bonus(CombatBonus.MELEE_DEFENCE, 70).bonus(CombatBonus.DEFENCE_MAGIC, 150)
