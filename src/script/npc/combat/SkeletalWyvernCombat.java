...
public class SkeletalWyvernCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        var dropTable =
                NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_10000).broadcast(true).log(true);
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(125).magicLevel(125).rangedLevel(120).defenceLevel(120)
                .bonus(CombatBonus.DEFENCE_STAB, 140).bonus(CombatBonus.DEFENCE_SLASH, 90)
    ...
    public boolean dropTableCanDropHook(Player player, int dropRateDivider, int roll, NpcCombatDropTable table) {
        return npc.getId() != NpcId.CURSED_WYVERN_210_16011 || player.getSkills().isWildernessSlayerTask(npc);
    }
}
