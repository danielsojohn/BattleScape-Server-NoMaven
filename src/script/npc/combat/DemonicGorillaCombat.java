...
import com.palidino.osrs.model.TileHitEvent;
...
public class DemonicGorillaCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        var dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_1500).log(true);
        ...
        combat.id(NpcId.DEMONIC_GORILLA_275).id(NpcId.DEMONIC_GORILLA_275_7145).id(NpcId.DEMONIC_GORILLA_275_7146);
    ...
    public void tickStartHook() {
        ...
        if (npc.getHitDelay() == 0 && npc.isAttacking() && attackStyle != HitType.MELEE && Utils.randomE(5) == 0
            ...
            npc.getWorld()
                    .addEvent(new TileHitEvent(4, npc.getController(), npc.getEngagingEntity(), 30, HitType.TYPELESS));
            ...
            npc.getController().sendMapProjectile(null, tile, npc.getEngagingEntity(), 856, 200, 1, 0, 126, 16, 64);
