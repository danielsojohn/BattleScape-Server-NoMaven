...
public class BattleMageCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        saradominCombat.stats(NpcCombatStats.builder().magicLevel(60).bonus(CombatBonus.ATTACK_MAGIC, 16)
                .bonus(CombatBonus.DEFENCE_MAGIC, 16).build());
    ...
    public boolean canBeAggressiveHook(Entity opponent) {
        ...
        if (npc.getId() == NpcId.BATTLE_MAGE_54 && (player.getEquipment().getWeaponId() == ItemId.ZAMORAK_STAFF
        ...
        if (npc.getId() == NpcId.BATTLE_MAGE_54_1611 && (player.getEquipment().getWeaponId() == ItemId.SARADOMIN_STAFF
        ...
        if (npc.getId() == NpcId.BATTLE_MAGE_54_1612 && (player.getEquipment().getWeaponId() == ItemId.GUTHIX_STAFF
