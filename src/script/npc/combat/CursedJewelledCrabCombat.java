...
public class CursedJewelledCrabCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(127).defenceLevel(127).bonus(CombatBonus.MELEE_DEFENCE, 127)
                .bonus(CombatBonus.DEFENCE_MAGIC, 5).bonus(CombatBonus.DEFENCE_RANGED, 127).build());
        ...
        redCombat.hitpoints(NpcCombatHitpoints.builder().total(255).bar(HitpointsBar.GREEN_RED_60).build());
        redCombat
                .stats(NpcCombatStats.builder().attackLevel(127).defenceLevel(127).bonus(CombatBonus.MELEE_DEFENCE, 127)
                        .bonus(CombatBonus.DEFENCE_MAGIC, 5).bonus(CombatBonus.DEFENCE_RANGED, 127).build());
        ...
        greenCombat.hitpoints(NpcCombatHitpoints.builder().total(255).bar(HitpointsBar.GREEN_RED_60).build());
        greenCombat
                .stats(NpcCombatStats.builder().attackLevel(127).defenceLevel(127).bonus(CombatBonus.MELEE_DEFENCE, 127)
                        .bonus(CombatBonus.DEFENCE_MAGIC, 5).bonus(CombatBonus.DEFENCE_RANGED, 127).build());
        ...
        blueCombat.hitpoints(NpcCombatHitpoints.builder().total(255).bar(HitpointsBar.GREEN_RED_60).build());
        blueCombat
                .stats(NpcCombatStats.builder().attackLevel(127).defenceLevel(127).bonus(CombatBonus.MELEE_DEFENCE, 127)
                        .bonus(CombatBonus.DEFENCE_MAGIC, 5).bonus(CombatBonus.DEFENCE_RANGED, 127).build());
        ...
        return Arrays.asList(combat.build(), redCombat.build(), greenCombat.build(), blueCombat.build());
    }
