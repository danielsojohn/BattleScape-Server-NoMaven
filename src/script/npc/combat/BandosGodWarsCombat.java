...
public class BandosGodWarsCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        jogreCombat.stats(
                NpcCombatStats.builder().attackLevel(43).defenceLevel(43).bonus(CombatBonus.MELEE_ATTACK, 22).build());
        ...
        var orkDrop = NpcCombatDrop.builder().clue(NpcCombatDrop.ClueScroll.HARD, NpcCombatDropTable.CHANCE_1_IN_128);
        ...
        orkCombat.stats(NpcCombatStats.builder().attackLevel(100).defenceLevel(60).bonus(CombatBonus.MELEE_ATTACK, 19)
                .bonus(CombatBonus.DEFENCE_STAB, 12).bonus(CombatBonus.DEFENCE_SLASH, 14)
                .bonus(CombatBonus.DEFENCE_CRUSH, 13).bonus(CombatBonus.DEFENCE_MAGIC, 5)
        ...
        var hobgoblinOrk = NpcCombatDrop.builder().rareDropTableRate(NpcCombatDropTable.CHANCE_1_IN_256);
        dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_RARE);
        ...
        var spiritualMageDrop = NpcCombatDrop.builder().rareDropTableRate(NpcCombatDropTable.CHANCE_1_IN_256);
        ...
        return Arrays.asList(jogreCombat.build(), cyclopsCombat.build(), orkCombat.build(), hobgoblinCombat.build(),
