...
public class SaradominGodWarsChamberCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        zilyanaCombat.stats(NpcCombatStats.builder().attackLevel(280).magicLevel(300).rangedLevel(250).defenceLevel(300)
        ...
        zilyanaCombat.focus(NpcCombatFocus.builder().keepWithinDistance(1).singleTargetFocus(true).build());
        ...
        var breeDrop = NpcCombatDrop.builder().clue(NpcCombatDrop.ClueScroll.HARD, NpcCombatDropTable.CHANCE_1_IN_128);
        ...
        dropTable.drop(NpcCombatDropTableDrop.builder().item(new RandomItem(ItemId.COINS, 1000, 5000, 40))
        ...
        breeCombat.spawn(NpcCombatSpawn.builder().respawnDelay(50).respawnWithId(NpcId.COMMANDER_ZILYANA_596)
                .respawnWithId(NpcId.STARLIGHT_149).respawnWithId(NpcId.GROWLER_139).build());
        breeCombat.hitpoints(NpcCombatHitpoints.total(162));
        breeCombat.stats(NpcCombatStats.builder().attackLevel(162).magicLevel(80).rangedLevel(150).defenceLevel(130)
        ...
        breeCombat.killCount(NpcCombatKillCount.builder().asName("Commander Zilyana's bodyguard").build());
        ...
        growlerCombat.spawn(NpcCombatSpawn.builder().respawnDelay(50).respawnWithId(NpcId.COMMANDER_ZILYANA_596)
        ...
        growlerCombat.killCount(NpcCombatKillCount.builder().asName("Commander Zilyana's bodyguard").build());
        ...
        starlightCombat.spawn(NpcCombatSpawn.builder().respawnDelay(50).respawnWithId(NpcId.COMMANDER_ZILYANA_596)
                .respawnWithId(NpcId.GROWLER_139).respawnWithId(NpcId.BREE_146).build());
        starlightCombat.hitpoints(NpcCombatHitpoints.total(160));
        starlightCombat.stats(NpcCombatStats.builder().attackLevel(120).magicLevel(125).defenceLevel(120)
        ...
        starlightCombat.killCount(NpcCombatKillCount.builder().asName("Commander Zilyana's bodyguard").build());
        ...
        return Arrays.asList(zilyanaCombat.build(), breeCombat.build(), growlerCombat.build(), starlightCombat.build());
    }
    ...
    public void restoreHook() {
        ...
        var respawns = new int[] {
            NpcId.STARLIGHT_149, NpcId.GROWLER_139, NpcId.BREE_146
        };
        for (var id : respawns) {
