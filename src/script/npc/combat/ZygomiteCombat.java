...
public class ZygomiteCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(75).magicLevel(75).rangedLevel(75).defenceLevel(75)
                .bonus(CombatBonus.MELEE_ATTACK, 30).bonus(CombatBonus.MELEE_DEFENCE, 10)
