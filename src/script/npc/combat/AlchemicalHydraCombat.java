...
public class AlchemicalHydraCombat extends NpcCombat {
    ...
    private static final NpcCombatStyle POISON_ATTACK_1 = POISON_ATTACK_BUILDER.animation(8234).build();
    private static final NpcCombatStyle POISON_ATTACK_2 = POISON_ATTACK_BUILDER.animation(8255).build();
    ...
    private static final MapObject[] VENTS = {
        BLUE_VENT, GREEN_VENT, RED_VENT
    };
    private static final Tile[] FIRE_TILES_NORTH = {
        new Tile(0, 1), new Tile(1365, 10271), new Tile(1366, 10271), new Tile(1367, 10271), new Tile(1368, 10271)
    };
    private static final Tile[] FIRE_TILES_EAST = {
        new Tile(1, 0), new Tile(1370, 10269), new Tile(1370, 10268), new Tile(1370, 10267), new Tile(1370, 10266)
    };
    private static final Tile[] FIRE_TILES_SOUTH = {
        new Tile(0, -1), new Tile(1365, 10264), new Tile(1366, 10264), new Tile(1367, 10264), new Tile(1368, 10264)
    };
    private static final Tile[] FIRE_TILES_WEST = {
        new Tile(-1, 0), new Tile(1363, 10269), new Tile(1363, 10268), new Tile(1363, 10267), new Tile(1363, 10266)
    };
    private static final Tile[] FIRE_TILES_NORTH_WEST = {
        new Tile(-1, 1), new Tile(1363, 10271), new Tile(1363, 10269), new Tile(1363, 10270), new Tile(1364, 10271),
        new Tile(1365, 10271)
    };
    private static final Tile[] FIRE_TILES_SOUTH_WEST = {
        new Tile(-1, -1), new Tile(1363, 10264), new Tile(1365, 10264), new Tile(1364, 10264), new Tile(1363, 10265),
        new Tile(1363, 10266)
    };
    private static final Tile[] FIRE_TILES_NORTH_EAST = {
        new Tile(1, 1), new Tile(1370, 10271), new Tile(1369, 10271), new Tile(1368, 10271), new Tile(1370, 10270),
        new Tile(1370, 10269)
    };
    private static final Tile[] FIRE_TILES_SOUTH_EAST = {
        new Tile(-1, 1), new Tile(1370, 10264), new Tile(1370, 10265), new Tile(1370, 10266), new Tile(1369, 10264),
        new Tile(1368, 10264)
    };
    ...
    private static final FireAttack[] FIRE_ATTACKS = {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_256).broadcast(true).log(true);
        ...
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(0.56).order(NpcCombatDropTable.Order.RANDOM_UNIQUE)
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(100).magicLevel(260).rangedLevel(260).defenceLevel(100)
                .bonus(CombatBonus.ATTACK_MAGIC, 45).bonus(CombatBonus.ATTACK_RANGED, 45)
        ...
        combat2.stats(
                NpcCombatStats.builder().attackLevel(100).magicLevel(260).rangedLevel(260).defenceLevel(100).build());
        ...
        combat3.hitpoints(NpcCombatHitpoints.builder().total(1100).bar(HitpointsBar.GREEN_RED_100).build());
        combat3.stats(NpcCombatStats.builder().attackLevel(100).magicLevel(260).rangedLevel(260).defenceLevel(100)
                .bonus(CombatBonus.ATTACK_MAGIC, 45).bonus(CombatBonus.ATTACK_RANGED, 45)
                .bonus(CombatBonus.DEFENCE_STAB, 75).bonus(CombatBonus.DEFENCE_SLASH, 150)
                .bonus(CombatBonus.DEFENCE_CRUSH, 150).bonus(CombatBonus.DEFENCE_MAGIC, 150)
                .bonus(CombatBonus.DEFENCE_RANGED, 45).build());
        ...
        combat4.hitpoints(NpcCombatHitpoints.builder().total(1100).bar(HitpointsBar.GREEN_RED_100).build());
        combat4.stats(NpcCombatStats.builder().attackLevel(100).magicLevel(260).rangedLevel(260).defenceLevel(100)
                .bonus(CombatBonus.ATTACK_MAGIC, 45).bonus(CombatBonus.ATTACK_RANGED, 45)
                .bonus(CombatBonus.DEFENCE_STAB, 75).bonus(CombatBonus.DEFENCE_SLASH, 150)
                .bonus(CombatBonus.DEFENCE_CRUSH, 150).bonus(CombatBonus.DEFENCE_MAGIC, 150)
                .bonus(CombatBonus.DEFENCE_RANGED, 45).build());
        ...
        combat5.hitpoints(NpcCombatHitpoints.builder().total(1100).bar(HitpointsBar.GREEN_RED_100).build());
        combat5.stats(NpcCombatStats.builder().attackLevel(100).magicLevel(260).rangedLevel(260).defenceLevel(100)
                .bonus(CombatBonus.ATTACK_MAGIC, 45).bonus(CombatBonus.ATTACK_RANGED, 45)
                .bonus(CombatBonus.DEFENCE_STAB, 75).bonus(CombatBonus.DEFENCE_SLASH, 150)
                .bonus(CombatBonus.DEFENCE_CRUSH, 150).bonus(CombatBonus.DEFENCE_MAGIC, 150)
                .bonus(CombatBonus.DEFENCE_RANGED, 45).build());
        ...
        return Arrays.asList(combat.build(), combat2.build(), combat3.build(), combat4.build(), combat5.build());
    }
    ...
    public NpcCombatStyle attackTickCombatStyleHook(NpcCombatStyle combatStyle, Entity opponent) {
        if (specialDelay == 0) {
            if (npc.getId() == NpcId.ALCHEMICAL_HYDRA_426 || npc.getId() == NpcId.ALCHEMICAL_HYDRA_426_8621) {
                var poisonAttack = npc.getId() == NpcId.ALCHEMICAL_HYDRA_426 ? POISON_ATTACK_1 : POISON_ATTACK_2;
    ...
    public double damageReceivedHook(Entity opponent, double damage, HitType hitType, HitType defenceType) {
        if (damageReduction) {
            ...
            if (opponent instanceof Player) {
                ...
                player.getGameEncoder().sendMessage("The Alchemical Hydra's defences partially absorb your attack!");
            }
        }
        return damage;
    }
    ...
    @Override
    public boolean dropTableCanDropHook(Player player, int dropRateDivider, int roll, NpcCombatDropTable table) {
