...
public class DarkBeastCombat extends NpcCombat {
    ...
    private static final NpcCombatDropTable SHARD_DROP_TABLE = NpcCombatDropTable.builder().chance(0.54)
    ...
    private static final NpcCombatStyle SPECIAL_ATTACK =
            NpcCombatStyle.builder().type(NpcCombatStyleType.MAGIC).damage(NpcCombatDamage.maximum(25))
                    .projectile(NpcCombatProjectile.builder().id(130).speedMinimumDistance(8).build()).animation(2731)
                    .attackSpeed(2).targetTileGraphic(new Graphic(101, 124))
                    .specialAttack(NpcCombatTargetTile.builder().radius(1).radiusProjectiles(true).build()).build();
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        cursedCombat.hitpoints(NpcCombatHitpoints.builder().total(550).bar(HitpointsBar.GREEN_RED_60).build());
        ...
        superiorCombat.hitpoints(NpcCombatHitpoints.builder().total(550).bar(HitpointsBar.GREEN_RED_60).build());
        ...
        return Arrays.asList(combat.build(), combat2.build(), cursedCombat.build(), superiorCombat.build());
    }
