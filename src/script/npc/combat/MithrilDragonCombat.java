...
public class MithrilDragonCombat extends NCombatScript {
    @Override
    public List<NpcCombatDefinition> getCombatDefs() {
        var drop = NpcCombatDrop.builder().rareDropTableRate(NpcCombatDropTable.CHANCE_1_IN_256)
                .clue(NpcCombatDrop.ClueScroll.ELITE, 0.29);
        var dropTable =
                NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_32768).broadcast(true).log(true);
        dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.DRAGON_FULL_HELM)));
        drop.table(dropTable.build());
        dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_10000).broadcast(true).log(true);
        ...
        combat.stats(NpcCombatStats.builder().attackLevel(268).magicLevel(168).rangedLevel(168).defenceLevel(268)
                .bonus(CombatBonus.DEFENCE_STAB, 50).bonus(CombatBonus.DEFENCE_SLASH, 100)
