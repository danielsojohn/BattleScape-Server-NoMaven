...
public class ArmadylGodWarsCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        var dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_128).log(true);
        ...
        spirituaMageCombat
                .stats(NpcCombatStats.builder().magicLevel(150).defenceLevel(111).bonus(CombatBonus.DEFENCE_STAB, 9)
                        .bonus(CombatBonus.DEFENCE_SLASH, 12).bonus(CombatBonus.DEFENCE_CRUSH, 5)
                        .bonus(CombatBonus.DEFENCE_MAGIC, 45).bonus(CombatBonus.DEFENCE_RANGED, 28).build());
        ...
        return Arrays.asList(spirituaMageCombat.build(), aviansie69Combat.build(), aviansie79Combat.build(),
                aviansie92Combat.build(), aviansie137Combat.build());
    }
