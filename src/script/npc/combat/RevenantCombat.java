...
public class RevenantCombat extends NpcCombat {
    ...
    private static final RandomItem[] UNIQUE_DROP_TABLE = {
        new RandomItem(ItemId.VIGGORAS_CHAINMACE_U, 1).weight(1), new RandomItem(ItemId.CRAWS_BOW_U, 1).weight(1),
        new RandomItem(ItemId.THAMMARONS_SCEPTRE_U, 1).weight(1), new RandomItem(ItemId.AMULET_OF_AVARICE, 1).weight(2)
    };
    private static final RandomItem[] MEDIOCRE_DROP_TABLE = {
        new RandomItem(ItemId.DRAGON_PLATELEGS, 1).weight(1), new RandomItem(ItemId.DRAGON_PLATESKIRT, 1).weight(1),
        new RandomItem(ItemId.RUNE_FULL_HELM, 1).weight(2), new RandomItem(ItemId.RUNE_PLATEBODY, 1).weight(2),
        new RandomItem(ItemId.RUNE_PLATELEGS, 1).weight(2), new RandomItem(ItemId.RUNE_KITESHIELD, 1).weight(2),
        new RandomItem(ItemId.RUNE_WARHAMMER, 1).weight(2), new RandomItem(ItemId.DRAGON_LONGSWORD, 1).weight(1),
        new RandomItem(ItemId.DRAGON_DAGGER, 1).weight(1), new RandomItem(ItemId.SUPER_RESTORE_4_NOTED, 3, 5).weight(4),
        ...
        new RandomItem(ItemId.DEATH_RUNE, 60, 100).weight(3), new RandomItem(ItemId.BLOOD_RUNE, 60, 100).weight(3),
        new RandomItem(ItemId.LAW_RUNE, 80, 120).weight(3), new RandomItem(ItemId.RUNITE_ORE_NOTED, 3, 6).weight(6),
        new RandomItem(ItemId.ADAMANTITE_BAR_NOTED, 8, 12).weight(6),
        new RandomItem(ItemId.COAL_NOTED, 50, 100).weight(6), new RandomItem(ItemId.BATTLESTAFF_NOTED, 3).weight(5),
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        impCombat.stats(NpcCombatStats.builder().attackLevel(5).magicLevel(9).rangedLevel(5).defenceLevel(4)
        ...
        goblinCombat.stats(NpcCombatStats.builder().attackLevel(13).magicLevel(12).rangedLevel(15).defenceLevel(14)
        ...
        pyrefiendCombat.stats(NpcCombatStats.builder().attackLevel(60).magicLevel(67).rangedLevel(40).defenceLevel(33)
        ...
        hobgoblinCombat.stats(NpcCombatStats.builder().attackLevel(50).magicLevel(55).rangedLevel(60).defenceLevel(41)
        ...
        cyclopsCombat.stats(NpcCombatStats.builder().attackLevel(60).magicLevel(65).rangedLevel(70).defenceLevel(49)
                .bonus(CombatBonus.MELEE_ATTACK, 53).bonus(CombatBonus.DEFENCE_STAB, 140)
        ...
        hellhoundCombat.stats(NpcCombatStats.builder().attackLevel(76).magicLevel(104).rangedLevel(80).defenceLevel(80)
                .bonus(CombatBonus.MELEE_ATTACK, 38).bonus(CombatBonus.ATTACK_MAGIC, 30)
        ...
        demonCombat.stats(NpcCombatStats.builder().attackLevel(83).magicLevel(120).rangedLevel(80).defenceLevel(80)
        ...
        orkCombat.stats(NpcCombatStats.builder().attackLevel(99).magicLevel(110).rangedLevel(130).defenceLevel(60)
        ...
        darkBeastCombat.stats(NpcCombatStats.builder().attackLevel(93).magicLevel(130).rangedLevel(135).defenceLevel(80)
                .bonus(CombatBonus.MELEE_ATTACK, 65).bonus(CombatBonus.ATTACK_RANGED, 45)
        ...
        knightCombat.stats(NpcCombatStats.builder().attackLevel(100).magicLevel(146).rangedLevel(146).defenceLevel(80)
        ...
        dragonCombat.stats(NpcCombatStats.builder().attackLevel(106).magicLevel(150).rangedLevel(151).defenceLevel(87)
                .bonus(CombatBonus.MELEE_ATTACK, 72).bonus(CombatBonus.ATTACK_MAGIC, 61)
        ...
        return Arrays.asList(impCombat.build(), goblinCombat.build(), pyrefiendCombat.build(), hobgoblinCombat.build(),
                cyclopsCombat.build(), hellhoundCombat.build(), demonCombat.build(), orkCombat.build(),
                darkBeastCombat.build(), knightCombat.build(), dragonCombat.build());
    }
