...
public class CaveKrakenCombat extends NpcCombat {
    ...
    private static final NpcCombatDropTable CURSED_DROP_TABLE = NpcCombatDropTable.builder()
            ...
            .drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.TRIDENT_OF_THE_SEAS_FULL).weight(8))).build();
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        var dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_1_IN_1200).log(true);
        ...
        combat.stats(NpcCombatStats.builder().magicLevel(120).defenceLevel(150).bonus(CombatBonus.DEFENCE_MAGIC, -63)
    ...
    public void tickStartHook() {
        ...
        } else if (npc.getId() == NpcId.CURSED_WHIRLPOOL_127_16014 || npc.getId() == NpcId.CURSED_KRAKEN_127_16013) {
            if (npc.getInCombatDelay() == 0 && !npc.isAttacking() && npc.getId() != NpcId.CURSED_WHIRLPOOL_127_16014) {
    ...
    public List<Item> deathDropItemsGetItemsHook(Npc npc, Player player, Tile dropTile, int dropRateDivider, int roll,
        ...
        if (npc.getId() == NpcId.CURSED_KRAKEN_127_16013 && SUPERIOR_DROP_TABLE.canDrop(npc, player)) {
