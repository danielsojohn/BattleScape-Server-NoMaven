...
public class MageArena2DemonCombat extends NpcCombat {
    ...
    public List<NpcCombatDefinition> getCombatDefinitions() {
        ...
        justiciarCombat.stats(NpcCombatStats.builder().attackLevel(500).magicLevel(180).defenceLevel(100)
    ...
    public boolean canBeAttackedHook(Entity opponent, boolean sendMessage, HitType hitType) {
        ...
        if (npc.getId() == NpcId.JUSTICIAR_ZACHARIAH_348_7858 && !spell.getName().equals("saradomin strike")) {
            if (sendMessage) {
            ...
            return false;
        } else if (npc.getId() == NpcId.PORAZDIR_235_7860 && !spell.getName().equals("flames of zamorak")) {
            if (sendMessage) {
