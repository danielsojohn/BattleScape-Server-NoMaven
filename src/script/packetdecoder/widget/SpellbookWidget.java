...
public class SpellbookWidget implements Widget {
    ...
    public int[] getIds() {
        return new int[] {
            WidgetId.SPELLBOOK, WidgetId.SPELL_SELECT, WidgetId.RUNE_POUCH
        };
    }
    ...
    public void execute(Player player, int index, int widgetId, int childId, int slot, int itemId) {
        if (widgetId == WidgetId.SPELLBOOK) {
            ...
            case DAREEYAK_TELEPORT:
                ...
                player.getMovement().animatedTeleport(new Tile(2968, 3695, height), Magic.ANCIENT_MAGIC_ANIMATION,
                        Magic.ANCIENT_MAGIC_GRAPHIC, 2);
                player.getController().stopWithTeleport();
                player.clearHits();
                AchievementDiary.castSpellUpdate(player, spellbookChild, null, null, null);
            ...
            case CARRALLANGER_TELEPORT:
                ...
                player.getMovement().animatedTeleport(new Tile(3175, 3669, height), Magic.ANCIENT_MAGIC_ANIMATION,
                        Magic.ANCIENT_MAGIC_GRAPHIC, 2);
                player.getController().stopWithTeleport();
                player.clearHits();
                AchievementDiary.castSpellUpdate(player, spellbookChild, null, null, null);
            ...
            case ANNAKARL_TELEPORT:
                ...
                player.getMovement().animatedTeleport(new Tile(3290, 3886, height), Magic.ANCIENT_MAGIC_ANIMATION,
                        Magic.ANCIENT_MAGIC_GRAPHIC, 2);
                player.getController().stopWithTeleport();
                player.clearHits();
                AchievementDiary.castSpellUpdate(player, spellbookChild, null, null, null);
            ...
            case GHORROCK_TELEPORT:
                ...
                player.getMovement().animatedTeleport(new Tile(2974, 3873, height), Magic.ANCIENT_MAGIC_ANIMATION,
                        Magic.ANCIENT_MAGIC_GRAPHIC, 2);
                player.getController().stopWithTeleport();
                player.clearHits();
                AchievementDiary.castSpellUpdate(player, spellbookChild, null, null, null);
