...
public class UseWidgetAction {
    ...
    public static void doActionPlayer(Player player, int index, int widgetId, int childId, int slot, Player player2) {
        if (widgetId == WidgetId.INVENTORY) {
            Item item = player.getInventory().getItem(slot);
            if (item == null) {
                return;
    ...
    public static void doActionWidgetOnWidget(Player player, int fromWidgetId, int fromChildId, int toWidgetId,
            int toChildId, int useSlot, int useItemId, int onSlot, int onItemId) {}

    public static void doActionMapObject(Player player, int widgetId, int childId, int itemSlot, MapObject object) {
        if (widgetId == WidgetId.INVENTORY) {
