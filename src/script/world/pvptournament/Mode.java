...
public class Mode {
    ...
    static {
        ...
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.HELM_OF_NEITIZNOT), new Item(ItemId.IMBUED_SARADOMIN_CAPE),
            new Item(ItemId.AMULET_OF_GLORY_4), new Item(ItemId.ANCIENT_STAFF), new Item(ItemId.MYSTIC_ROBE_TOP),
            new Item(ItemId.SPIRIT_SHIELD), null, new Item(ItemId.MYSTIC_ROBE_BOTTOM), null,
            new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.DRAGON_BOOTS), null, new Item(ItemId.SEERS_RING_I), null
        }, new Item[] {
            new Item(ItemId.SARADOMIN_DHIDE), new Item(ItemId.ABYSSAL_WHIP), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.rune(ItemId.DEATH_RUNE).rune(ItemId.BLOOD_RUNE).rune(ItemId.WATER_RUNE);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.SERPENTINE_HELM), new Item(ItemId.IMBUED_SARADOMIN_CAPE), new Item(ItemId.AMULET_OF_FURY),
            new Item(ItemId.TOXIC_STAFF_OF_THE_DEAD), new Item(ItemId.AHRIMS_ROBETOP),
            new Item(ItemId.BLESSED_SPIRIT_SHIELD), null, new Item(ItemId.AHRIMS_ROBESKIRT), null,
            new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.DRAGON_BOOTS), null, new Item(ItemId.SEERS_RING_I), null
        }, new Item[] {
            new Item(ItemId.KARILS_LEATHERTOP), new Item(ItemId.ABYSSAL_TENTACLE),
        ...
        mode.loadout(new Loadout.Entry("Load-out #1", new Item[] {
            new Item(ItemId.SERPENTINE_HELM), new Item(ItemId.IMBUED_SARADOMIN_CAPE), new Item(ItemId.AMULET_OF_FURY),
            new Item(ItemId.TOXIC_STAFF_OF_THE_DEAD), new Item(ItemId.ANCESTRAL_ROBE_TOP),
            new Item(ItemId.ARCANE_SPIRIT_SHIELD), null, new Item(ItemId.ANCESTRAL_ROBE_BOTTOM), null,
            new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.PRIMORDIAL_BOOTS), null, new Item(ItemId.SEERS_RING_I),
            null
        }, new Item[] {
            new Item(ItemId.ARMADYL_CHESTPLATE), new Item(ItemId.ABYSSAL_TENTACLE),
            new Item(ItemId.SUPER_COMBAT_POTION_4), new Item(ItemId.SARADOMIN_BREW_4),
        ...
        mode.loadout(new Loadout.Entry("Load-out #3", new Item[] {
            ...
            new Item(ItemId.ARMADYL_CHESTPLATE), new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.loadout(new Loadout.Entry("Load-out #4", new Item[] {
            new Item(ItemId.SERPENTINE_HELM), new Item(ItemId.IMBUED_SARADOMIN_CAPE), new Item(ItemId.AMULET_OF_FURY),
            new Item(ItemId.TOXIC_STAFF_OF_THE_DEAD), new Item(ItemId.ANCESTRAL_ROBE_TOP),
            new Item(ItemId.ARCANE_SPIRIT_SHIELD), null, new Item(ItemId.ANCESTRAL_ROBE_BOTTOM), null,
            new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.PRIMORDIAL_BOOTS), null, new Item(ItemId.SEERS_RING_I),
        ...
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            ...
            new Item(ItemId.AMULET_OF_GLORY_4), new Item(ItemId.ANCIENT_STAFF), new Item(ItemId.MYSTIC_ROBE_TOP),
            new Item(ItemId.SPIRIT_SHIELD), null, new Item(ItemId.MYSTIC_ROBE_BOTTOM), null,
            new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.DRAGON_BOOTS), null, new Item(ItemId.SEERS_RING_I),
            new Item(ItemId.DRAGONSTONE_BOLTS_E, 8000)
        }, new Item[] {
            new Item(ItemId.RUNE_CROSSBOW), new Item(ItemId.ABYSSAL_WHIP), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            ...
            new Item(ItemId.ARMADYL_CROSSBOW), new Item(ItemId.ABYSSAL_TENTACLE),
            new Item(ItemId.SUPER_COMBAT_POTION_4), new Item(ItemId.SARADOMIN_BREW_4),
        ...
        mode.loadout(new Loadout.Entry("Load-out #3", new Item[] {
            ...
            new Item(ItemId.ARMADYL_CROSSBOW), new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.rune(ItemId.DEATH_RUNE).rune(ItemId.BLOOD_RUNE).rune(ItemId.WATER_RUNE);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.GHOSTLY_HOOD), new Item(ItemId.IMBUED_ZAMORAK_CAPE), new Item(ItemId.AMULET_OF_GLORY_4),
            new Item(ItemId.ANCIENT_STAFF), new Item(ItemId.GHOSTLY_ROBE), new Item(ItemId.BOOK_OF_DARKNESS), null,
            new Item(ItemId.GHOSTLY_ROBE_6108), null, new Item(ItemId.MITHRIL_GLOVES), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.SEERS_RING_I), new Item(ItemId.DRAGONSTONE_BOLTS_E, 8000)
        }, new Item[] {
            new Item(ItemId.RUNE_CROSSBOW), new Item(ItemId.AVAS_ACCUMULATOR), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ZAMORAK_CHAPS),
        ...
        mode.rune(ItemId.DEATH_RUNE).rune(ItemId.BLOOD_RUNE).rune(ItemId.WATER_RUNE);
        mode.loadout(new Loadout.Entry("Load-out #1", new Item[] {
            new Item(ItemId.ELDER_CHAOS_HOOD), new Item(ItemId.IMBUED_ZAMORAK_CAPE), new Item(ItemId.AMULET_OF_FURY),
            new Item(ItemId.TOXIC_STAFF_OF_THE_DEAD), new Item(ItemId.ELDER_CHAOS_TOP), new Item(ItemId.MAGES_BOOK),
            null, new Item(ItemId.ELDER_CHAOS_ROBE), null, new Item(ItemId.REGEN_BRACELET),
            new Item(ItemId.CLIMBING_BOOTS), null, new Item(ItemId.SEERS_RING_I),
            new Item(ItemId.DRAGONSTONE_BOLTS_E, 8000)
        }, new Item[] {
            new Item(ItemId.ARMADYL_CROSSBOW), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.loadout(new Loadout.Entry("Load-out #1", new Item[] {
            ...
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.DHAROKS_PLATEBODY), new Item(ItemId.AVERNIC_DEFENDER),
        ...
        mode.loadout(new Loadout.Entry("Load-out #2", new Item[] {
            new Item(ItemId.DHAROKS_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.DHAROKS_PLATEBODY), new Item(ItemId.AVERNIC_DEFENDER), null,
        ...
        mode.loadout(new Loadout.Entry("+ Super Combat Potion (4)", new Item(ItemId.SUPER_COMBAT_POTION_4)));
        mode.loadout(new Loadout.Entry("+ Armadyl Godsword", new Item(ItemId.ARMADYL_GODSWORD)));
        ...
        mode.rune(ItemId.ASTRAL_RUNE).rune(ItemId.DEATH_RUNE).rune(ItemId.EARTH_RUNE);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.BERSERKER_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.DRAGON_SCIMITAR), new Item(ItemId.FIGHTER_TORSO), new Item(ItemId.RUNE_DEFENDER), null,
            new Item(ItemId.RUNE_PLATELEGS), null, new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.RUNE_BOOTS), null,
            new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            new Item(ItemId.BARRELCHEST_ANCHOR), new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.loadout(new Loadout.Entry("Load-out #1", new Item[] {
            new Item(ItemId.BERSERKER_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.MAGIC_SHORTBOW_I), new Item(ItemId.FIGHTER_TORSO), null, null,
            new Item(ItemId.ZAMORAK_CHAPS), null, new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.RUNE_BOOTS), null,
            new Item(ItemId.BERSERKER_RING_I), new Item(ItemId.AMETHYST_ARROW_P_PLUS_PLUS, 8000)
        }, new Item[] {
            null, new Item(ItemId.RUNE_DEFENDER), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.RANGING_POTION_4), new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Load-out #2", new Item[] {
            new Item(ItemId.BERSERKER_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.RUNE_KNIFE_P_PLUS_PLUS, 8000), new Item(ItemId.FIGHTER_TORSO),
            new Item(ItemId.RUNE_DEFENDER), null, new Item(ItemId.ZAMORAK_CHAPS), null, new Item(ItemId.BARROWS_GLOVES),
            new Item(ItemId.RUNE_BOOTS), null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            null, new Item(ItemId.RANGING_POTION_4), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.COOKED_KARAMBWAN),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.rune(ItemId.ASTRAL_RUNE).rune(ItemId.DEATH_RUNE).rune(ItemId.EARTH_RUNE);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.HELM_OF_NEITIZNOT), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_GLORY_4),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.FIGHTER_TORSO), new Item(ItemId.DRAGON_DEFENDER), null,
            new Item(ItemId.DRAGON_PLATELEGS), null, new Item(ItemId.BARROWS_GLOVES), new Item(ItemId.DRAGON_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
        ...
        mode.rune(ItemId.ASTRAL_RUNE).rune(ItemId.DEATH_RUNE).rune(ItemId.EARTH_RUNE);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.SERPENTINE_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.FIGHTER_TORSO), new Item(ItemId.DRAGON_DEFENDER), null,
            new Item(ItemId.DHAROKS_PLATELEGS), null, new Item(ItemId.FEROCIOUS_GLOVES), new Item(ItemId.DRAGON_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            null, new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Load-out #1", new Item[] {
            new Item(ItemId.SERPENTINE_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.BANDOS_CHESTPLATE), new Item(ItemId.AVERNIC_DEFENDER),
            null, new Item(ItemId.BANDOS_TASSETS), null, new Item(ItemId.FEROCIOUS_GLOVES),
            new Item(ItemId.PRIMORDIAL_BOOTS), null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            null, new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Load-out #2", new Item[] {
            new Item(ItemId.SERPENTINE_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.BANDOS_CHESTPLATE), new Item(ItemId.AVERNIC_DEFENDER), null,
            new Item(ItemId.BANDOS_TASSETS), null, new Item(ItemId.FEROCIOUS_GLOVES), new Item(ItemId.PRIMORDIAL_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            null, new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Melee Load-out #1", new Item[] {
            new Item(ItemId.IRON_FULL_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_STRENGTH),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.IRON_PLATEBODY), new Item(ItemId.BOOK_OF_WAR), null,
            new Item(ItemId.IRON_PLATELEGS), null, new Item(ItemId.MITHRIL_GLOVES), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), new Item(ItemId.WAR_BLESSING)
        }, new Item[] {
            new Item(ItemId.DRAGON_DAGGER_P_PLUS_PLUS), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Melee Load-out #2", new Item[] {
            new Item(ItemId.BEARHEAD), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.IRON_PLATEBODY), new Item(ItemId.BOOK_OF_WAR), null,
            new Item(ItemId.IRON_PLATELEGS), null, new Item(ItemId.REGEN_BRACELET), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), new Item(ItemId.WAR_BLESSING)
        }, new Item[] {
            new Item(ItemId.ARMADYL_GODSWORD), new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.COOKED_KARAMBWAN),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.COOKED_KARAMBWAN), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Melee Load-out #3", new Item[] {
            new Item(ItemId.BEARHEAD), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.IRON_PLATEBODY), new Item(ItemId.BOOK_OF_WAR), null,
            new Item(ItemId.IRON_PLATELEGS), null, new Item(ItemId.REGEN_BRACELET), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), new Item(ItemId.WAR_BLESSING)
        }, new Item[] {
            new Item(ItemId.ARMADYL_GODSWORD), new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.loadout(new Loadout.Entry("Ranged Load-out #1", new Item[] {
            new Item(ItemId.LEATHER_COWL), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.AMULET_OF_GLORY_4),
            new Item(ItemId.RUNE_KNIFE_P_PLUS_PLUS, 8000), new Item(ItemId.LEATHER_BODY), new Item(ItemId.BOOK_OF_LAW),
            null, new Item(ItemId.SARADOMIN_CHAPS), null, new Item(ItemId.MITHRIL_GLOVES),
        ...
        mode.loadout(new Loadout.Entry("Ranged Load-out #2", new Item[] {
            new Item(ItemId.LEATHER_COWL), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.AMULET_OF_GLORY_4),
            new Item(ItemId.MAGIC_SHORTBOW_I), new Item(ItemId.LEATHER_BODY), null, null,
            new Item(ItemId.SARADOMIN_CHAPS), null, new Item(ItemId.MITHRIL_GLOVES), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.ARCHERS_RING_I), new Item(ItemId.AMETHYST_ARROW_P_PLUS_PLUS, 8000)
        }, new Item[] {
        ...
        mode.loadout(new Loadout.Entry("Ranged Load-out #3", new Item[] {
            new Item(ItemId.LEATHER_COWL), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.AMULET_OF_GLORY_4),
            new Item(ItemId.RUNE_CROSSBOW), new Item(ItemId.LEATHER_BODY), new Item(ItemId.BOOK_OF_LAW), null,
            new Item(ItemId.SARADOMIN_CHAPS), null, new Item(ItemId.MITHRIL_GLOVES), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.ARCHERS_RING_I), new Item(ItemId.DRAGONSTONE_BOLTS_E, 8000)
        }, new Item[] {
            new Item(ItemId.DARK_BOW), new Item(ItemId.DRAGON_ARROW_P_PLUS_PLUS, 8000),
            new Item(ItemId.BASTION_POTION_4), new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.COOKED_KARAMBWAN), new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.SARADOMIN_BREW_4),
        ...
        mode.loadout(new Loadout.Entry("Magic Load-out", new Item[] {
            new Item(ItemId.GHOSTLY_HOOD), new Item(ItemId.IMBUED_ZAMORAK_CAPE), new Item(ItemId.AMULET_OF_GLORY_4),
            new Item(ItemId.STAFF_OF_THE_DEAD), new Item(ItemId.GHOSTLY_ROBE), new Item(ItemId.TOME_OF_FIRE), null,
            new Item(ItemId.GHOSTLY_ROBE_6108), null, new Item(ItemId.MITHRIL_GLOVES), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.SEERS_RING_I), new Item(ItemId.ANCIENT_BLESSING)
        }, new Item[] {
        ...
        mode.loadout(new Loadout.Entry("Melee Load-out #4", new Item[] {
            new Item(ItemId.BEARHEAD), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.IRON_PLATEBODY), new Item(ItemId.BOOK_OF_WAR), null,
            new Item(ItemId.IRON_PLATELEGS), null, new Item(ItemId.REGEN_BRACELET), new Item(ItemId.CLIMBING_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), new Item(ItemId.WAR_BLESSING)
        ...
        mode.loadout(new Loadout.Entry("Ranged Load-out #1", new Item[] {
            ...
            new Item(ItemId.DRAGON_KNIFE_P_PLUS_PLUS, 8000), new Item(ItemId.RANGERS_TUNIC),
            new Item(ItemId.BOOK_OF_LAW), null, new Item(ItemId.SARADOMIN_CHAPS), null, new Item(ItemId.RANGER_GLOVES),
        ...
        mode.loadout(new Loadout.Entry("Ranged Load-out #2", new Item[] {
            new Item(ItemId.ROBIN_HOOD_HAT), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.NECKLACE_OF_ANGUISH),
            new Item(ItemId._3RD_AGE_BOW), new Item(ItemId.RANGERS_TUNIC), null, null, new Item(ItemId.SARADOMIN_CHAPS),
            null, new Item(ItemId.RANGER_GLOVES), new Item(ItemId.RANGER_BOOTS), null, new Item(ItemId.ARCHERS_RING_I),
            new Item(ItemId.DRAGON_ARROW_P_PLUS_PLUS, 8000)
        }, new Item[] {
            new Item(ItemId.DARK_BOW), new Item(ItemId.ANGLERFISH), new Item(ItemId.BASTION_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Ranged Load-out #3", new Item[] {
            new Item(ItemId.ROBIN_HOOD_HAT), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.NECKLACE_OF_ANGUISH),
            new Item(ItemId.ARMADYL_CROSSBOW), new Item(ItemId.RANGERS_TUNIC), new Item(ItemId.BOOK_OF_LAW), null,
            new Item(ItemId.SARADOMIN_CHAPS), null, new Item(ItemId.RANGER_GLOVES), new Item(ItemId.RANGER_BOOTS), null,
            new Item(ItemId.ARCHERS_RING_I), new Item(ItemId.DRAGONSTONE_BOLTS_E, 8000)
        }, new Item[] {
            new Item(ItemId.DARK_BOW), new Item(ItemId.DRAGON_ARROW_P_PLUS_PLUS, 8000),
            new Item(ItemId.BASTION_POTION_4), new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.COOKED_KARAMBWAN),
        ...
        mode.loadout(new Loadout.Entry("Magic Load-out", new Item[] {
            ...
            new Item(ItemId.TOXIC_STAFF_OF_THE_DEAD), new Item(ItemId.ELDER_CHAOS_TOP), new Item(ItemId.TOME_OF_FIRE),
            null, new Item(ItemId.ELDER_CHAOS_ROBE), null, new Item(ItemId.TORMENTED_BRACELET),
            new Item(ItemId.WIZARD_BOOTS), null, new Item(ItemId.SEERS_RING_I), new Item(ItemId.ANCIENT_BLESSING)
        }, new Item[] {
            new Item(ItemId.SARADOMIN_SWORD), new Item(ItemId.ANGLERFISH), new Item(ItemId.BATTLEMAGE_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.COOKED_KARAMBWAN), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.VOID_RANGER_HELM), new Item(ItemId.AVAS_ASSEMBLER), new Item(ItemId.NECKLACE_OF_ANGUISH),
            new Item(ItemId.DRAGON_KNIFE, 8000), new Item(ItemId.VOID_KNIGHT_TOP), new Item(ItemId.RUNE_KITESHIELD),
        ...
        mode.rune(ItemId.ASTRAL_RUNE).rune(ItemId.DEATH_RUNE).rune(ItemId.EARTH_RUNE);
        mode.loadout(new Loadout.Entry("Load-out #1", new Item[] {
            new Item(ItemId.HELM_OF_NEITIZNOT), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.MONKS_ROBE_TOP), new Item(ItemId.AVERNIC_DEFENDER), null,
            new Item(ItemId.MONKS_ROBE), null, new Item(ItemId.FEROCIOUS_GLOVES), new Item(ItemId.PRIMORDIAL_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            null, new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
            new Item(ItemId.SARADOMIN_BREW_4), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.loadout(new Loadout.Entry("Load-out #2", new Item[] {
            new Item(ItemId.HELM_OF_NEITIZNOT), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_TORTURE),
            new Item(ItemId.GHRAZI_RAPIER), new Item(ItemId.MONKS_ROBE_TOP), new Item(ItemId.AVERNIC_DEFENDER), null,
            new Item(ItemId.MONKS_ROBE), null, new Item(ItemId.FEROCIOUS_GLOVES), new Item(ItemId.PRIMORDIAL_BOOTS),
            null, new Item(ItemId.BERSERKER_RING_I), null
        }, new Item[] {
            null, new Item(ItemId.ANGLERFISH), new Item(ItemId.SUPER_COMBAT_POTION_4),
        ...
        mode.rune(ItemId.DEATH_RUNE).rune(ItemId.BLOOD_RUNE).rune(ItemId.WATER_RUNE);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            new Item(ItemId.DHAROKS_HELM), new Item(ItemId.INFERNAL_CAPE), new Item(ItemId.AMULET_OF_FURY),
            new Item(ItemId.ABYSSAL_TENTACLE), new Item(ItemId.DHAROKS_PLATEBODY), new Item(ItemId.DRAGON_DEFENDER),
            null, new Item(ItemId.DHAROKS_PLATELEGS), null, new Item(ItemId.BARROWS_GLOVES),
            new Item(ItemId.DRAGON_BOOTS), null, new Item(ItemId.RING_OF_RECOIL), null
        }, new Item[] {
            new Item(ItemId.MYSTIC_ROBE_TOP_DARK), new Item(ItemId.ANCIENT_STAFF), new Item(ItemId.RING_OF_RECOIL),
            new Item(ItemId.SUPER_COMBAT_POTION_4), new Item(ItemId.MYSTIC_ROBE_BOTTOM_DARK),
            new Item(ItemId.SPIRIT_SHIELD), new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.SARADOMIN_BREW_4),
            new Item(ItemId.BLACK_DHIDE_BODY), new Item(ItemId.IMBUED_SARADOMIN_CAPE), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.COOKED_KARAMBWAN), new Item(ItemId.GRANITE_MAUL), new Item(ItemId.DHAROKS_GREATAXE),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.COOKED_KARAMBWAN), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH), new Item(ItemId.COOKED_KARAMBWAN),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.COOKED_KARAMBWAN), new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
        ...
        mode.attackLevel(99).strengthLevel(99).rangedLevel(99).magicLevel(99).defenceLevel(99).hitpointsLevel(99)
                .prayerLevel(99);
        mode.loadout(new Loadout.Entry("Load-out", new Item[] {
            null, null, null, new Item(ItemId.ABYSSAL_TENTACLE), null, null, null, null, null, null, null, null, null,
            null
        }, new Item[] {
